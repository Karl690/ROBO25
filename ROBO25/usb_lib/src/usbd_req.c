...
//GBXXX static uint8_t USBD_GetLen(uint8_t *buf);
...
/**
  ...
  * @retval None
  */
//GB XXX void USBD_GetString(uint8_t *desc, uint8_t *unicode, uint16_t *len)
