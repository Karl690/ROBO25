/**
  ...
  ******************************************************************************
  */
 extern void Crash_Handler(char *); //GB XXX added

/*----------Stack Configuration-----------------------------------------------*/
#define STACK_SIZE       0x00000800      //GB XXX was: 0x00000200      /*!< The Stack size suggest using even number    */
